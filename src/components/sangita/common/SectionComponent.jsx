...
export function SectionComponent({id,number, sHeading, heading, containerSize, bgColor, data }) {
    return (
        <section
            id={id}
            aria-labelledby={`${id}-title`}
            className={`scroll-mt-14 py-16 sm:scroll-mt-32 sm:py-20 lg:py-20 ${bgColor}`}
        >
            <Container size={containerSize}>
                ...
                {data.map(d =>
                    <p key = "" className="mt-4 text-lg tracking-tight text-slate-900">
                        {d}
                    </p>
