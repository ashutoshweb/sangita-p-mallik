...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Early Life</span>
        <span className="lg:hidden">Early Life</span>
      </>
    ),
  },
  { id: 'resillience-and-sustainability', title: 'Resilience and Sustainability' },
  { id: 'youth-outreach', title: 'Youth' },
  { id: 'awards', title: 'Awards and Recognition' },
  { id: 'author', title: 'Vision' },
]
...
export function NavBar() {
  ...
  return (
    <div ref={navBarRef} className="sticky top-0 z-50 bg-green-900">
